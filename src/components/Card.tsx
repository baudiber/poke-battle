...
const Card: React.FC<CardProps> = ({ pokemon, selected }) => {
    ...
    return (
        <div className={` bg-gradient-to-r from-amber-300 via-amber-100 to-amber-300  p-1 rounded-2xl w-[250px] shadow-md outline-orange-400 ${selected ? 'outline outline-8 ' : 'hover:outline-dashed'}`}
